...
public class CitaDAO {
  ...
  /***
   * Verifica si la hora y fecha de la cita esta disponible
   * 
   * @param fecha fecha de la cita
   * @param hora hora de la cita
   * @return true si la fecha esta disponible y false sino
   */
  public boolean validalidarDisponibilidadDeCita(String fecha, String hora) throws SQLException{
    ...
    try {
      conexion = new ConnectionToBD().getConexion();
      PreparedStatement sentenciaSQL = conexion.prepareStatement("select * from cita where fecha = ? and hora = ?");
